...
public class TalismanModel extends EntityModel<TalismanEntity> {
    ...
    @Override
    public void setRotationAngles(TalismanEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
