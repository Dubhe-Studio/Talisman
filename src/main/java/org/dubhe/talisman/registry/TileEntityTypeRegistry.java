...
public class TileEntityTypeRegistry {
    ...
    public static RegistryObject<TileEntityType<TalismanCraftingTableTileEntity>> TALISMAN_CRAFTING_TABLE = TILE_ENTITY_TYPE.register("talisman_crafting_table", () -> TileEntityType.Builder.create(TalismanCraftingTableTileEntity::new, BlockRegistry.TALISMAN_CRAFTING_TABLE.get()).build(null));
