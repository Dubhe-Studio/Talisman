...
public class TPotions {
    ...
    public static final RegistryObject<Potion> BURNING_POTION = POTION.register("burning", () -> new Potion(new EffectInstance(TEffects.BURNING.get(), 900)));
    public static final RegistryObject<Potion> LONG_BURNING_POTION = POTION.register("long_burning", () -> new Potion(new EffectInstance(TEffects.BURNING.get(), 1800)));
    public static final RegistryObject<Potion> STRONG_BURNING_POTION = POTION.register("strong_burning", () -> new Potion(new EffectInstance(TEffects.BURNING.get(), 432, 1)));
